...
class ClusterEventPublisher:
    ...
    def publish_cluster_in_protected_mode_events(
            self):
        timestamp = ClusterEventPublisher.timestamp()
    ...
    # Example event generated by this function:
    # {
    #     "datetime": "2023-06-06T17:25:00.965+00:00",
    #     "version": 0,
    #     "scheduler": "slurm",
    #     "cluster-name": "FriLog3",
    #     "node-role": "HeadNode",
    #     "component": "clustermgtd",
    #     "level": "ERROR",
    #     "instance-id": "i-021991f56a9a1717f",
