...
class ClusterEventPublisher:
    ...
    # Example event generated by this function:
    # {
    #     "datetime": "2023-06-15T02:49:12.749+00:00",
    #     "version": 0,
    #     "scheduler": "slurm",
    #     "cluster-name": "gpu-cluster25",
    #     "node-role": "HeadNode",
    #     "component": "clusterjobinfomgtd",
    #     "level": "INFO",
    #     "instance-id": "i-0332623ed854e713f",
    ...
    #         "job_state": "COMPLETED",
    #         "run_time": "00:00:30",
    #         "start_time": "2023-06-15T02:46:10.000+00:00",
    #         "end_time": "2023-06-15T02:46:40.000+00:00",
    #         "partition": "compute",
    #         "node_list": "compute-dy-defaultcompute-1",
    #         "nodes": ["compute-dy-defaultcompute-1"],
    #         "cpu_ids": ["0"], "gres": []
    #     }
    # }
    @log_exception(logger, "publish_job_info_events", catch_exception=Exception, raise_on_error=False)
    def publish_job_info_events(self, jobs: List[SlurmJobInfo]):
        """Publish events for job information."""
        timestamp = ClusterEventPublisher.timestamp()
        self.publish_event(
            logging.DEBUG,
            **SCONTROL_SHOW_JOB_COUNT,
            timestamp=timestamp,
            event_supplier=self._job_count_supplier(jobs),
        )
        self.publish_event(
            logging.INFO,
            **SCONTROL_SHOW_JOB_INFORMATION,
            timestamp=timestamp,
            event_supplier=self._job_info_supplier(jobs),
        )
                ...
                "node_list": [
                    {
                        ...
                        "core_count": node.instance.cpu_usage,
                    }
                    for node in nodes
                ],
            }
