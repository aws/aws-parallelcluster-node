...
@pytest.mark.parametrize(
    ...
    [
        ...
        (SlurmNode("queue1-st-c5xlarge-1", "nodeip", "nodehostname", "DOWN+CLOUD+DRAIN", "queue1"), False),
        (
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            SlurmNode("queue1-dy-c5xlarge-1", "nodeip", "nodehostname", "IDLE+CLOUD+POWERED_DOWN+POWER_DOWN", "queue1"),
            True,
        ),
        (
            SlurmNode(
