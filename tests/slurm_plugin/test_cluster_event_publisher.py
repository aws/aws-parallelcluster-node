...
from slurm_plugin.clustermgtd import ComputeFleetStatus, ClusterManager
    ...
    [
        ...
        (
                ...
                [
                    ...
                    {"node-launch-failure-count": {"failure-type": "vcpu-limit-failures", "count": 0,
                                                   "error-details": {}}},
                    {
                        "node-launch-failure-count": {
                            "failure-type": "volume-limit-failures",
                    ...
                    {"node-launch-failure-count": {"failure-type": "iam-policy-errors", "count": 0,
                                                   "error-details": {}}},
                    {
                        "node-launch-failure": {
                            "node": {
                ...
                [
                    ...
                    },
                    {
                        "node-launch-failure-count": {
                            ...
                            "count": 5,
                            "error-details": {
                                "VolumeLimitExceeded": {"count": 2,
                                                        "nodes": [{"name": "vle-h-1"}, {"name": "vle-h-2"}]},
                                "InsufficientVolumeCapacity": {
                                    "count": 3,
                    ...
                    },
                    {
                        "node-launch-failure-count": {
                            ...
                            "count": 2,
                            "error-details": {
                                "UnauthorizedOperation": {"count": 2,
                                                          "nodes": [{"name": "iam-k-1"}, {"name": "iam-k-2"}]}
                            },
                        }
                    },
                ],
